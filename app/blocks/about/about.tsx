...
function AboutBlock( {
    ...
    return (
        <>
            <div className='bg-white pb-[268px] pt-[80px] md:pt-[100px] relative' id='about'>
                <svg className="absolute inset-0 h-full w-full stroke-gray-200 stroke-gradient-to-b [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)]" aria-hidden="true">
                    <defs>
                ...
                <div className="container grid md:grid-cols-2 max-w-[1144px] gap-x-8 lg:gap-x-[121px] my-auto align-middle">
                    <div className="text-container lg:max-w-[461px] my-auto">
                        <h2 className='text-light-blue-05 font-oswald mb-3 text-[24px] md:text-[29px] md:leading-[25.536px] md:tracking-[0.44px] lg:text-[40px] md:mb-6'>ABOUT ME</h2>
